...
Locker.prototype.run = function(fn, ctx) {
    return joinQueue.call(this, fn, ctx, false, this.promise);
};
...
Locker.prototype.lock = function(fn, ctx) {
    return joinQueue.call(this, fn, ctx, true, this.promise);
};
 ...
 * @param {*} [promise] - Promise class to use
 * @returns {Promise} - Promise which resolves/rejects with eventual outcome of `fn()`
 */
function joinQueue(fn, ctx, exclusive, promise) {
    // Promisify `fn`
    fn = promisify(fn, 0);
